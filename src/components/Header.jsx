    ...
    >
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a href="#contato" className="btn btn-primary text-sm px-6 py-2">
            Iniciar Projeto
          </a>
        </nav>
            ...
            >
              {navLinks.map(link => (
                <motion.a
                  ...
                  className="text-lg font-semibold text-dark-text hover:text-primary transition-colors duration-300"
